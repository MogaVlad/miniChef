...
export default function EnterTheCommunity() {
  return (
<section className='items-center flex flex-col bg-gray-300 justify-center w-full h-[415px]'>
      <section className='container mx-auto p-4 items-center justify-center'> 
        <h2 className='text-center text-2xl mt-[-6px] mb-6 font-semibold'> Enter the community </h2>
